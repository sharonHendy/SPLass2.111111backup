...
public abstract class MicroService implements Runnable {
    ...
    private Map<Class<? extends Message>, Callback> msgAndCallbacks;//stores the messages the ms is subscribed to and their callbacks
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        msgAndCallbacks.put(type,callback);
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                if(message != null) {
                    Callback callback = msgAndCallbacks.get(message.getClass());
